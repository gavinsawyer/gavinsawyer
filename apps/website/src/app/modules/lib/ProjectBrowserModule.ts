...
import { AnalyticsService, AppCheckService, AuthService, DatabaseService, DatePipe, ENVIRONMENT, FindRouteByPathPipe, FirebaseAppService, FirestoreService, FunctionsService, GIT_INFO_PARTIAL, logo, LOGO, PACKAGE_REPOSITORY_URL, PACKAGE_VERSION, PROJECT_NAME }                                                                                                                                                                                                        from "@bowstring/core";
...
@NgModule(
  {
    ...
    providers:    [
      ...
      {
        provide:  PACKAGE_REPOSITORY_URL,
        useValue: packageRepositoryUrl,
      },
      {
