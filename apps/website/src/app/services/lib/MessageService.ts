...
export class MessageService {
  ...
  private readonly documentSnapshotObservable: Observable<QueryDocumentSnapshot<MessageDocument, MessageDocument> | undefined> = this.authenticationService.userObservable.pipe<QueryDocumentSnapshot<MessageDocument, MessageDocument> | undefined, QueryDocumentSnapshot<MessageDocument, MessageDocument> | undefined>(
    ...
    shareReplay<QueryDocumentSnapshot<MessageDocument, MessageDocument> | undefined>(
      {
        bufferSize: 1,
        refCount:   true,
      },
